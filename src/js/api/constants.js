 ...
 * @constant {string}
 */
export const ACCESS_TOKEN = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiU09DQU5JQ09ERSIsImVtYWlsIjoiYXplc2FtMDI3NDVAc3R1ZC5ub3JvZmYubm8iLCJpYXQiOjE3NDU3MDg2MTl9.ZZ4OUekOyb0bbVD0C_sROe13PMekYxqgrv1Mj_5qw6Y";
...
export const API_PROFILE_SEARCH = (query) => `${API_PROFILES_BASE}/search?q=${query}`;    // GET
export const API_PROFILE_FOLLOW = (name) => `${API_PROFILES_BASE}/${name}/follow`;        // PUT
export const API_PROFILE_UNFOLLOW = (name) => `${API_PROFILES_BASE}/${name}/unfollow`;    // PUT
